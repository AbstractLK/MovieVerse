...
export const Header = () => {
  ...
  return (
    <div>
      <nav className="w-full bg-white border-b-2 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
        <div className="max-w-screen-xl w-full flex flex-wrap items-center justify-between mx-auto p-3">
          <Link
            to="/"
